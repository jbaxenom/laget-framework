...
public class RestCall {
    ...
    public RestCall(HttpClientWrapper client, String callType) {
        this.client = client;
    ...
    public RestCall withEndpoint(String endpoint) {
    ...
    public HttpCall send() {
        ...
        if (endpoint == null) {
            throw new RuntimeException("Endpoint not defined. Please set the endpoint variable to the address the call " +
                    "should be sent to");
        }
