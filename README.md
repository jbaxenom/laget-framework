...
So for several years now, every time I solved a particular challenge related to making test automation more effective, or to be able to test a different kind of software, I added it to LAGET. One important detail is that LAGET is something that has _worked for me_. I do not claim that it is going to solve your particular automation challenges (like too many libraries and frameworks out there do), or that it is a piece of java art (I actually don't consider myself good in programming). However, I do think LAGET is a humble but useful combination of core settings, methodologies, best practices and out-of-the-box tools. It has always helped me as a **good start point to create GUI tests for Desktop Web, Mobile Web and Mobile apps, or API tests for RESTfull webservices**, so I wanted to share it with everyone.
